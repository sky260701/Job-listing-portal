    ...
    <div>
      <form action="">
        <div
          ...
          <div class="relative md:mb-6 focus:outline-white border-neutral-50 border-white" data-te-input-wrapper-init>
  ...
  {/* <label
    ...
    >Email address
          ...
          <div class="mb-6 md:mr-auto">
            <button
              type="submit"
              class="inline-block rounded border-2 border-neutral-50 px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-neutral-50 transition duration-150 ease-in-out hover:border-neutral-100 hover:bg-indigo-600 hover:bg-opacity-10 hover:text-neutral-100 focus:border-neutral-100 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-neutral-200 dark:hover:bg-indigo-600 dark:hover:bg-opacity-10 bg-indigo-600"
              data-te-ripple-init
              data-te-ripple-color="light">
              Subscribe
            </button>
