...
function Navbar() {
 ...
 const handlecartpage = () => {
  ...
  return (
    <div>
         {/* <header className="w-full bg-gray-800 shadow sticky fixed">
          ...
          <div>
            ...
            >
              <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                ...
                <li class="font-sans block mt-4 lg:inline-block lg:mt-0 lg:ml-6 align-middle text-white hover:text-white-700">
  <a href="#" role="button" class="relative flex" onClick={handlecartpage} >
